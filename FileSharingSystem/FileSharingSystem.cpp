...
// FileSharingSystem.cpp : 定义应用程序的类行为。
//
...
// 唯一的一个 CFileSharingSystemApp 对象

CFileSharingSystemApp theApp;


// CFileSharingSystemApp 初始化
...
BOOL CFileSharingSystemApp::InitInstance()
{
	...
	dlg.Create(CFileSharingSystemDlg::IDD); //创建为非模态对话框
